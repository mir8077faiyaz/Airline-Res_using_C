/* MEMBER 1 - Mir Faiyaz Hossain , ID 2011385042
   MEMBER 2 -Mahirul Alam Chowdhury, ID 2013445042
   MEMBER 3 -Anika Hossain Sharna ,ID 2013322642
   PROJECT - AEROPLANE MANAGEMENT SYSTEM
*/
...
int main ()
{
    ...
    printf("------------------------------------------------------------------------------------------- \n");
    printf("\t \t []users can select from the multiple pakcakges made available by admin \n");
    printf("\n \t\t <ARE YOU AN ADMINISTRATOR ? ------>PRESS 2 TO ENTER ADMINSTRATOR SECTION> \n");
    printf("------------------------------------------------------------------------------------------- \n");
    printf("\t \t []admin creates and modifies packages,search up users and has access to many more functions !!\n");
    printf("\t \t []if you are a new admin, please head to the admin section to first create an Admin account\n");
    printf("\t \t []New admin must create Packages for users to purchase them\n");
    char p;
    scanf(" %c",&p);
    ...
    {
        int k=0;
        printf("\n \t \t ==>> WANT TO CREATE AN ADMIN ACCOUNT ? PRESS 3 \n");
        printf("\n \t \t ==>> TO LOGIN TO ADMIN ACCOUNT PRESS 4 \n");
        char d;
        scanf(" %c",&d);
        system("cls");
            ...
            if(d=='3')
            {
                ...
                system("cls");
                printf("ADMIN ACCOUNT CREATED SUCCESSFULLY !! PLEASE RE RUN THE PROGRAM \n");
            }
            else if(d=='4')
            {
...
void AddPackage(void)
{
    ...
    {
        printf("%d \n",i+1);
        printf("Enter pakage no in the format 'PKG%d' \n",i+1);
...
int admincreate(void)
{
    ...
    printf("enter user name [USER NAME MUST NOT CONTAIN ANY SPACES] \n");
    fflush(stdin);
    gets(a1.nam);
